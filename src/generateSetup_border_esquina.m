function [gainOverNoisedB,R,pilotIndex,D,D_small,APpositions,UEpositions,distances] = generateSetup_border_esquina(squareLength,L,K,N,tau_p,nbrOfSetups,seed,ASD_varphi,ASD_theta)
...
for n = 1:nbrOfSetups
    ...
    wrapHorizontal = repmat([-(squareLength+1) 0 (squareLength+1)],[3 1]);
