function [SE_PMMSE_DCC] = Uplink_OP_P_MMSE_SWR(squareLength,L,N,K)
...
for n = 1:nbrOfSetups
    ...
    % %Generate one setup with UEs and APs at random locations (sin wr)
    [~,R,pilotIndex,D,D_small] = generateSetup_sin_wr_border_esquina(squareLength,L,K,N,tau_p,1,n,ASD_varphi,ASD_theta);
